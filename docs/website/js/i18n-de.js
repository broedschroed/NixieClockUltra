const I18N_DE = {
  ...
  "aufbau.logic.p3": "Neu in Rev 2.1: Lichtsensor-Anschluss <strong>J5</strong> (LDR, GPIO6) für den automatischen Nacht-Modus sowie ein <strong>TLP627</strong>-Optokoppler (U7, GPIO7), der die Anodenspannung per Hardware-PWM (2&ndash;60&nbsp;%) dimmt. Optional lässt sich dieser eine Schalter durch 6 separate TLP627 (U5&ndash;U10) auf dem Nixie Display Board ersetzen, einen pro Röhre, für unabhängiges Dimmen jeder Ziffer beim weichen Ziffernwechsel.",
  ...
  "galerie.h1": "Galerie",
  "galerie.h2.fertig": "Die fertige Uhr",
  "galerie.h2.projekt": "Das Projekt",
};
