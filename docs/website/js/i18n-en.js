const I18N_EN = {
  ...
  "aufbau.logic.p3": "New in Rev 2.1: light-sensor connector <strong>J5</strong> (LDR, GPIO6) for automatic night mode, plus a <strong>TLP627</strong> optocoupler (U7, GPIO7) that dims the anode voltage via hardware PWM (2&ndash;60&nbsp;%). This single switch can optionally be replaced by 6 separate TLP627 optocouplers (U5&ndash;U10) on the Nixie Display Board, one per tube, for independently dimming each digit during the soft digit transition.",
